...
- Hero redesign + bolder art direction (2026-09-15): portrait protagonist in hero (red offset frame, crop marks, caption bar, floating 7+ badge, parallax), serif-italic accent headline line (Instrument Serif via font-accent), avatar chip intro, red primary CTA, full-bleed red manifesto band (BoldStatement.jsx) between Positioning and marquee, giant outlined UX/UI background word. MaskedLines supports accentIndex. Verified light + dark via screenshots.
